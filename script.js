...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function openChatbot() {
        ...
        if (chatbotState.conversationHistory.length === 0) {
            setTimeout(() => {
                addBotMessage("Hello! 👋 Welcome to the Champions Mentorship Program. I'm your AI-powered enrollment assistant, here to help you with program information, consultations, and enrollment support. To get started, may I know your full name?");
            }, 500);
        }
    }
    ...
    function handleNameInput(name) {
        ...
        if (!isValidName(name)) {
            if (chatbotState.nameAttempts >= chatbotState.maxNameAttempts) {
                ...
                addBotMessage(`No worries! I'll address you as <strong>Valued Student</strong> for now. 😊 You can always share your name later. Let me tell you about our Champions Mentorship Program!`);
    ...
    function handleMenuSelection(selection) {
        ...
        const intentHandlers = {
            ...
            'location': () => {
                addBotMessage(`Great question! The Champions Mentorship Program is 100% online. You can join from anywhere in the world. All sessions are conducted via professional video conferencing tools, giving you complete flexibility with location and scheduling. Your home is your classroom! 🌍`);
...
Whether you prefer an accelerated or relaxed pace, the program adapts to your lifestyle.`);
            ...
            'farewell': () => {
                addBotMessage(`It was wonderful assisting you, ${chatbotState.userName}! 🌟 Remember, the Champions Mentorship Program is your gateway to building a thriving digital career. Whenever you're ready to take the next step, I'm just a click away. Wishing you all the best! 🚀`);
                clearSuggestedButtons();
            },
            'greeting': () => {
                addBotMessage(`Hello again, ${chatbotState.userName}! 😊 How can I help you? Feel free to choose from the options below or type your question.`);
                showMainMenu();
            },
            'positive': () => {
        ...
        const buttonRoutes = {
            ...
            "no, that's all for now": () => { addBotMessage(`Thank you for chatting, ${chatbotState.userName}! 🌟 Feel free to return anytime. Best wishes on your journey! 🚀`); clearSuggestedButtons(); },
...
<p>Is everything correct? Please confirm to finalize your booking.</p>`);
    ...
    function showAppointmentSummary() {
        ...
        setTimeout(() => {
            addBotMessage(`Thank you for scheduling your consultation, ${chatbotState.userName}! 🌟 Is there anything else you'd like to know?`);
    ...
    function showChampionDetails() {
        addBotMessage(`<strong>🏆 Champions Mentorship Program</strong>
...
<ul style="margin-left: 20px; padding-left: 10px;">
    <li>🎯 Personalized 1-on-1 sessions with flexible scheduling</li>
    <li>📚 Mastery of 15+ in-demand digital skills</li>
    ...
    <li>🎥 Bonus: Digital Marketing, Domain Flipping & YouTube Automation</li>
    <li>🤝 Lifetime personalized mentor support (even after graduation)</li>
    <li>🔧 Hands-on real-world projects in every module</li>
    <li>🌍 100% remote: learn and work from anywhere</li>
...
Trusted by thousands of students worldwide. Our most loved and highly recommended program.`);
    ...
    function showCurriculum() {
        addBotMessage(`<strong>📘 Curriculum Overview</strong>
...
<p><em>Every module includes real-world projects and assignments. You'll build a professional portfolio as you learn.</em></p>`);
    ...
    function showCareerOpportunities() {
        addBotMessage(`<strong>💼 Career & Earning Opportunities</strong>

Graduates unlock multiple career paths:

<ul style="margin-left: 20px; padding-left: 10px;">
    <li>🏢 <strong>Guaranteed Job Placement</strong> (Remote work with our partnered agency)</li>
    <li>💻 <strong>Freelancing</strong> (Upwork, Fiverr & Freelancer platforms)</li>
    <li>🛍️ <strong>E-Commerce Business</strong> (Launch online stores with zero fees)</li>
    <li>📱 <strong>Social Media Management</strong> (Manage brands professionally)</li>
    <li>🔍 <strong>SEO Consulting</strong> (Help businesses rank higher on search engines)</li>
    <li>🎥 <strong>YouTube Revenue</strong> (Automated channel income streams)</li>
    <li>🌐 <strong>Domain Flipping</strong> (Premium domain reselling for profit)</li>
    <li>📈 <strong>Launch Your Own Agency</strong> (With the skills you've mastered)</li>
</ul>
...
<ul style="margin-left: 20px; padding-left: 10px;">
    <li>📊 <strong>Thousands of students</strong> enrolled with careers transformed</li>
    <li>💰 <strong>85%+ graduates</strong> start earning within 30 days</li>
    <li>🌍 Active students from <strong>15+ countries</strong></li>
    ...
    <li>📈 Alumni have built <strong>six-figure businesses</strong></li>
</ul>
...
<p><em>The results speak for themselves: consistent effort paired with expert mentorship accelerates careers by years.</em></p>`);
    ...
    function showIdealCandidate() {
        addBotMessage(`<strong>🎯 Who Is This Program For?</strong>
...
<ul style="margin-left: 20px; padding-left: 10px;">
    ...
    <li>✅ You're a <strong>student, professional, or homemaker</strong> seeking flexible income</li>
    <li>✅ You want to master <strong>multiple digital skills</strong> in one program</li>
...
<p><strong>No prior experience required!</strong> The only prerequisite is a genuine commitment to learning and growth.</p>`);
    ...
    function showFeeStructure() {
        addBotMessage(`<strong>💰 Fee Structure</strong>
...
<ul style="margin-left: 20px; padding-left: 10px;">
    <li>🌐 Lifetime FREE hosting with SSL (Save Rs. 18,000/year)</li>
    <li>🛒 Zero e-commerce platform fees (Save $300+/year)</li>
    <li>📚 Bonus courses included at no extra cost</li>
...
<p><em>Need international payment options? Contact us via WhatsApp and we'll accommodate your needs.</em></p>`);
    ...
    function showRegistrationProcess() {
        addBotMessage(`<strong>📝 3-Step Enrollment Process</strong>
...
<ul style="margin-left: 20px; padding-left: 10px;">
    ...
    <li>✅ Lifetime mentor support included</li>
